# USAGE
# python bank_check_box.py --image example_check.png --reference micr_e13b_reference.png
# python bank_check_box.py --image ticket_restaurant_2014.jpg --reference ocr_digit_exemple.jpg
